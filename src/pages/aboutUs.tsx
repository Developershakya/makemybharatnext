...
//     bio: "With over 15 years of experience in tech leadership, Sarah founded our company with a vision to revolutionize the industry.",
//   },
//   {
//     name: "Michael Chen",
//     role: "CTO",
//     image: "/placeholder.svg?height=300&width=300",
//     bio: "Michael brings deep technical expertise and has led engineering teams at Fortune 500 companies for over a decade.",
//   },
//   {
//     name: "Emily Rodriguez",
//     role: "Head of Design",
//     image: "/placeholder.svg?height=300&width=300",
//     bio: "Emily's creative vision and user-centered approach have shaped our product design philosophy from day one.",
//   },
//   {
//     name: "David Kim",
//     role: "VP of Marketing",
//     image: "/placeholder.svg?height=300&width=300",
//     bio: "David's strategic marketing insights have helped us build meaningful connections with our global customer base.",
//   },
// ];
           ...
           <div className="max-w-7xl mx-auto">
                  ...
                  <div className="space-y-4  text-base leading-relaxed">
                    <p className="text-lg  mb-6">
                      ...
                      you’re seeking a serene getaway, an adventurous escape, or
                      a cultural exploration, we curate experiences that cater
                    ...
                    <p className="text-lg  mb-6">
                      <strong>Local and Global Reach:</strong> From exploring
                      the hidden gems of India to venturing abroad, our
                      extensive network allows us to offer a wide range of tour
                      options.
                    </p>
                    ...
                    <p className="text-lg  mb-6">
                      ...
                      bearing the Corporate Identification Number (CIN){" "}
          ...
          <Card>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className=" text-center">
                ...
                <p className="text-lg  mb-6">
                  Our mission is to enhance our platforms usability and expand
                  our travel offerings, focusing on delivering personalized and
                  seamless experiences. We aim to increase customer engagement,
                  establish partnerships with key local destinations, and build
                  brand awareness to become a trusted name in Indias travel
                  industry.
                </p>
              ...
              <Card>
               <div className="text-center">
                ...
                <p className="text-lg mb-6 ">
                  Our long-term vision for Make My Bharat Yatra is to become
                  Indias leading travel platform, offering seamless,
                  personalized experiences. We aim to promote sustainable
                  tourism, connect travelers globally with Indias rich heritage,
                  and provide innovative, customer-focused services that make
                  exploring Bharat effortless, memorable, and accessible for
                  all.
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                ...
                unique expertise and passion to drive our mission forward.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
