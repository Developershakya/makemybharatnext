...
<div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-lg p-5 space-y-4">
  {/* Title */}
  <h1 className="capitalize text-3xl font-semibold text-gray-900">
    Goa hero package with complimentary activities
  </h1>
  ...
  {/* Images */}
  <div className="grid grid-cols-2 gap-3 h-[250px] rounded-xl">
    {/* Left Big Image */}
 ...
 <div className="px-4 py-6">
      ...
      <div className="max-w-7xl mx-auto flex space-x-8 bg-white p-4 shadow-md rounded-t-lg -mt-2">
        <a href="#" className="text-blue-600 font-semibold border-b-2 border-blue-600 pb-1">Itinerary</a>
        <a href="#" className="text-gray-600 hover:text-blue-600">Policies</a>
        <a href="#" className="text-gray-600 hover:text-blue-600">Summary</a>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-6 grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 bg-white rounded-lg shadow p-8">
          ...
          <section className="mb-8">
            <h3 className="text-lg font-bold text-gray-800">Day 1: Arrival in Goa</h3>
            <p className="text-sm text-red-600">Note: You need to reach Goa on your own.</p>

            <div className="mt-4 border p-5 rounded-lg bg-gray-50">
              <h4 className="font-semibold">Private Transfer</h4>
              <p className="text-sm text-gray-700">Airport to hotel via private cab</p>
            </div>

            <div className="mt-4 border p-5 rounded-lg bg-gray-50">
              <h4 className="font-semibold">Resort Stay: Luxury Goa Resort</h4>
              <p className="text-sm text-gray-700">3 Nights | Deluxe Room w/ Balcony</p>
              <img
          ...
          {/* Day 2 */}
          <section className="mb-8">
            <h3 className="text-lg font-bold text-gray-800">Day 2: Water Sports Activity</h3>
            <div className="mt-4 border p-5 rounded-lg bg-gray-50">
              <h4 className="font-semibold">Double Decker Boat Party with Water Sports</h4>
              <p className="text-sm text-gray-700">4 Hours | Includes water sports, lunch & transfers</p>
              <img
          ...
          {/* Day 3 */}
          <section className="mb-8">
            <h3 className="text-lg font-bold text-gray-800">Day 3: Leisure Day</h3>
            <p className="text-sm text-gray-700">Enjoy resort amenities or add optional activities as you like.</p>
          </section>

          {/* Day 4 */}
          <section>
            <h3 className="text-lg font-bold text-gray-800">Day 4: Departure</h3>
            <p className="text-sm text-red-600">Note: Departure from Goa on your own.</p>
          </section>
        </div>
        ...
        <aside className="col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="font-semibold text-gray-800 mb-3">Coupons & Offers</h3>
            <div className="bg-gray-100 p-4 rounded-lg mb-2">
              <p className="text-sm font-medium text-gray-800">FREEDOMSALE</p>
